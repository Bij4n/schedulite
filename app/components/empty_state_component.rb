class EmptyStateComponent < ViewComponent::Base
  ...
  def call
    tag.div(class: "flex flex-col items-center justify-center py-16 text-center") do
      safe_join([
        tag.div(class: "mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-teal-50") do
        ...
        tag.h3(@title, class: "text-sm font-semibold text-gray-900"),
